  ...
  const fetchProducts = async () => {
    try {
      ...
      if (res.ok && response.success) {
        ...
        // Filter only fruits
        setProducts(transformedProducts.filter((product: Product) => product.type === 'Fruit'))
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-red-600">Fresh Fruits</h1>
              <p className="ml-4 text-gray-600">Sweet and juicy selection</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Fresh & Juicy Fruits</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Hand-picked at peak ripeness, our fruits deliver exceptional flavor and nutrition in every bite.
          </p>
        </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {cartItems.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 mb-6">Add some delicious fruits to get started!</p>
                  <button
                    onClick={() => setIsCartOpen(false)}
                    ...
                    <div key={item.product.id} className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4">
                            <span className="text-lg font-bold text-red-600">Rs.{item.product.price}</span>
            ...
            {cartItems.length > 0 && (
              <div className="border-t border-gray-100 p-6 bg-gray-50 rounded-b-2xl">
                <div className="space-y-3 mb-6">
                  ...
                  <div className="border-t pt-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-2xl font-bold text-red-600">Rs.{getCartTotal()}</span>
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button className="bg-red-600 text-white py-3 rounded-lg font-medium hover:bg-red-700 transition-colors shadow-lg">
                    Proceed to Checkout
                  </button>
                </div>
              </div>
